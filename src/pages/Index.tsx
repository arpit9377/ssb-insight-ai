          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-3xl font-bold">PsychSirAi</h3>
              </div>
              <p className="text-gray-400 max-w-lg text-lg leading-relaxed">
                Empowering future officers with AI-powered psychological test preparation. 
                Master your SSB tests with personalized feedback and comprehensive analysis.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  >
                    ...
                    <span className="font-medium">Join our Telegram Group</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/about')}>
                  About Us
                </Button>
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/services')}>
                  Our Services
                </Button>
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/subscription')}>
                  Pricing Plans
                </Button>
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/contact')}>
                  Contact Support
                </Button>
              </div>
            </div>
            ...
            {/* Legal & Support */}
            <div className="space-y-6">
              <h4 className="text-xl font-semibold text-white">Legal & Support</h4>
              <div className="space-y-3">
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/terms')}>
                  Terms & Conditions
                </Button>
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/privacy')}>
                  Privacy Policy
                </Button>
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/refunds')}>
                  Refund Policy
                </Button>
                <Button variant="link" className="text-gray-400 hover:text-white p-0 h-auto justify-start text-base" onClick={() => navigate('/faq')}>
                  FAQ & Help
                </Button>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-gray-400 text-base">
                &copy; 2024 PsychSirAi. All rights reserved.
              </p>
              <p className="text-gray-400 text-base">
                Made with ❤️ for future officers
              </p>
            </div>
          </div>
        </div>
